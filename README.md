...
- Artificial reverberation & room acoustics modelling
- Differentiable DSP: IIR filters, FDNs, Distortion, Compressor
- Audio effects modelling & style transfer
- Deep Learning & Machine learning for audio
- Embedded systems: FPGA, DSP, FreeRTOS, Electronics
